...
public class ExcelCreator {
	...
	public final String DATA_STORE = "data/generated_files/";
	...
	private void createExcelForAll() throws IOException {
		...
		while (iter.hasNext()) {
			...
			if (s.getPassed().equals("YES")) {
				...
				// set locker password - (21009 + 44 = 21015)
		...
		System.out.printf("Excel file successfully created for all the Students. Files are in: \"%s\" folder \n",
				DATA_STORE);
